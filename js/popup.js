...
(function () {
  ...
  var fillFeaturesListElement = function (ad, features) {
    utilModule.deleteChildElement(featuresListElement);
  ...
  var fillPhotosListElement = function (ad, photos) {
    utilModule.deleteChildElement(photosListElement);
  ...
  var initAdPopupElement = function (ad) {
    ...
    adPopupElement.querySelector('.popup__type').textContent = utilModule.housingTypeMap[ad.offer.type].TYPE;
